...
/***/ "./resources/assets/js/Classes/Cart.js":
/*!*********************************************!*\
  !*** ./resources/assets/js/Classes/Cart.js ***!
  \*********************************************/
...
var Cart = /*#__PURE__*/function () {
  ...
  _createClass(Cart, [{
    key: "updateHeaderCart",
    value: function updateHeaderCart(items) {
      var headerCart = document.querySelector(".cart-count");
...
var __webpack_exports__ = {};
/*!****************************************!*\
  !*** ./resources/assets/js/lib/lib.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Classes_Cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Classes/Cart */ "./resources/assets/js/Classes/Cart.js");


var cart = new _Classes_Cart__WEBPACK_IMPORTED_MODULE_1__["default"]();

(function () {
  "use strict";

  BASEOBJECT.module = {
    addItemToCart: function addItemToCart(id, title, qty) {
      var tokenEl = document.querySelector(".custom-token");
      var token = tokenEl.dataset.token;
      var url = "".concat(themeUrl, "/inc/app/Routes/ShopAddItem.php");
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, JSON.stringify({
        product_id: id,
        title: title,
        qty: qty,
        token: token,
...
(function () {
  ...
  BASEOBJECT.gallery.init = function () {
    var body = document.querySelector("#photoarchivePage");
    var modal = document.querySelector(".archive-gallery-modal");
    var wrapper = document.querySelector(".gallery-outer-wrapper");
    var imgContainer = document.querySelector(".archive-gallery-img-container");
    wrapper.addEventListener("click", function (e) {
      ...
      if (target.classList.contains("archive-gallery-img")) {
        ...
        var imgUrl = target.dataset.url;
        var htmlEl = "<div class=\"modal-img-outer-wrapper\"><img class=\"w-100\" src=\"".concat(imgUrl, "\"></div>");
...
(() => {
/*!****************************************************!*\
  !*** ./resources/assets/js/profile/copyBilling.js ***!
  \****************************************************/
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
(function () {
  ...
  BASEOBJECT.profile.copyBillingDetails = function () {
    var body = document.querySelector("#profilePage");
    var billingEls = document.querySelectorAll(".billing-input");
    var shippingEls = document.querySelectorAll(".shipping-input");
    body.addEventListener('click', function (e) {
      ...
      if (el.classList.contains("copy-billing")) {
        ...
        _toConsumableArray(billingEls).map(function (input, index) {
...
var __webpack_exports__ = {};
/*!**********************************************!*\
  !*** ./resources/assets/js/products/shop.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
    ...
    var app = new Vue({
      ...
      methods: {
        getProducts: function getProducts() {
          axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(themeUrl, "/inc/app/Routes/Shop.php")).then(function (resp) {
            console.log(resp["data"]["data"]);
            app.products = resp["data"]["data"];
          });
        },
        addToCart: function addToCart(id, title, qty) {
...
var __webpack_exports__ = {};
/*!******************************************!*\
  !*** ./resources/assets/js/cart/cart.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
    ...
    var app = new Vue({
      ...
      methods: {
        displayItems: function displayItems() {
          axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(themeUrl, "/inc/app/Routes/GetCartItems.php")).then(function (response) {
            if (response.data.fail) {
              app.fail = true;
        ...
        updateQuantity: function updateQuantity(product_id, operator) {
          axios__WEBPACK_IMPORTED_MODULE_0___default().post("".concat(themeUrl, "/inc/app/Routes/UpdateCartQty.php"), JSON.stringify({
        ...
        removeItem: function removeItem(index) {
          axios__WEBPACK_IMPORTED_MODULE_0___default().post("".concat(themeUrl, "/inc/app/Routes/RemoveCartItem.php"), JSON.stringify({
            item_index: index
          })).then(function (response) {
