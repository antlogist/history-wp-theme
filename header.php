        ...
        <div class="col-6">
          <ul class="login-ul-main">
            <?php if (isAuthenticated()) { ?>
              <li><a href="<?php echo get_home_url(); ?>/user"><span class="dashicons dashicons-admin-users" style="padding-top: 2px;"></span><?php echo Session::get("SESSION_USER_NAME"); ?></a> </li>
              <li><a href="<?php echo get_home_url(); ?>/logout">
